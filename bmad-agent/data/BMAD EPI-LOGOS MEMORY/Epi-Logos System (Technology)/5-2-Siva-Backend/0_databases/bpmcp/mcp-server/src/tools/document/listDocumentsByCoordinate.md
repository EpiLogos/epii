# listDocumentsByCoordinate.ts - BMAD Memory Documentation

## File Location
**Path**: `epii_app/friendly-file-backend/databases/bpmcp/mcp-server/src/tools/document/listDocumentsByCoordinate.ts`
**Bimba Coordinate**: `#5-2-0-32`
