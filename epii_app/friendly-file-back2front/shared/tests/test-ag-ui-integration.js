...
const { AGUIEventTypes, createAGUIEvent, validateAGUIEvent } = require('./shared/ag-ui/ag-ui-event-schema');
const { A2AAGUIEventTypes, createAGUIA2AMessage, isAGUIEvent } = require('./shared/a2a/a2a-message.schema');
