...
import { chunkDocument, sendChunksToLightRAG } from '../../utils/document.utils.mjs';
import { generateContextWindow } from '../../utils/content/context.mjs';
    ...
    try {
        ...
        if (sourceMetadata.documentId && documentContent && sourceMetadata.targetCoordinate) {
            try {
                ...
                const { hasBeenRecentlyIngested } = await import('../../utils/document.utils.mjs');
