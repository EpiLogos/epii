...
import { getDocumentFromCache, updateDocumentInCache } from './documentCache.utils.mjs';
...
export async function updateDocumentWithAnalysisResults(documentId, sourceMetadata, notionUpdatePayload, _) {
    ...
    try {
        ...
        const { storeAnalysisResultsInCache } = await import('./documentCache.utils.mjs');
...
export async function updateDocumentIngestionMetadata(documentId, _, targetCoordinate, bpMCPService) {
    ...
    try {
        ...
        try {
            const { invalidateDocumentCache } = await import('./documentCache.utils.mjs');
